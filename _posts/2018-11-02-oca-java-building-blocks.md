...
●	to run use java with the classname as parameter
...
○	8 bits
●	Integer.MAX_VALUE gives maximum value of int
...
Remark: When a String which is null is printed with System.out.println, the word null is printed.
Variable scope
